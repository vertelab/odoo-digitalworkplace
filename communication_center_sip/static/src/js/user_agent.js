odoo.define('communication_center_sip.UserAgent', function (require) {
"use strict";
...
const UserAgent = Class.extend(mixins.EventDispatcherMixin, ServicesMixin, {
    ...
    _configureDomElements() {
        ...
        this._audioRingbackTone.src = '/communication_center_sip/static/src/sounds/ringbacktone.mp3';
        ...
        this._audioIncomingRingtone.src = '/communication_center_sip/static/src/sounds/incomingcall.mp3';
        ...
        this._audioDialRingtone.src = '/communication_center_sip/static/src/sounds/dialtone.mp3';
