odoo.define('communication_center_sip.PhoneCallTab', function (require) {
"use strict";

const PhoneCall = require('communication_center_sip.PhoneCall');
const PhoneCallDetails = require('communication_center_sip.PhoneCallDetails');
...
const PhoneCallTab = Widget.extend({
    template: 'communication_center_sip.PhoneCallTab',
    custom_events: {
