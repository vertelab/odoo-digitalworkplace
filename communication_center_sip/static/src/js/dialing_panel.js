odoo.define('communication_center_sip.DialingPanel', function (require) {
"use strict";

const PhoneCallActivitiesTab = require('communication_center_sip.PhoneCallActivitiesTab');
const PhoneCallContactsTab = require('communication_center_sip.PhoneCallContactsTab');
const PhoneCallRecentTab = require('communication_center_sip.PhoneCallRecentTab');
const UserAgent = require('communication_center_sip.UserAgent');
...
const DialingPanel = Widget.extend({
    template: 'communication_center_sip.DialingPanel',
    events: {
